const API_KEY = '8ba555274912283fc0233f6db337c8e5';
...
function init() {
    updateDate();
    fetchWeather('Gateshead');// Is the default city
...
async function fetchWeather(city) {
    try {
        ...
        const response = await fetch(`http://localhost/weather-app/weather.php?q=${city}`);
